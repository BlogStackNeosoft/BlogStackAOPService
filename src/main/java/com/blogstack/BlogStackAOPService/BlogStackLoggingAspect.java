package com.blogstack.BlogStackAOPService;
...
@Aspect
@Configuration
public class BlogStackLoggingAspect {
    private static final Logger LOGGER = LoggerFactory.getLogger(BlogStackLoggingAspect.class);

    @Pointcut(value = "execution(* com.blogstack..*(..))")
